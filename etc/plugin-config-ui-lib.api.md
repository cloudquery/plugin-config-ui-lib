...
export function CloudAppMock({
  ...
  teamName,
  user,
}: CloudAppMockProps): JSX_2.Element;
...
// @public
export const ExclusiveToggle: ForwardRefExoticComponent<
  ExclusiveToggleProps & RefAttributes<HTMLElement>
>;
...
export function FormFieldReset({
  ...
  sx,
}: FormFieldResetProps): JSX_2.Element;
...
export function LightboxImage({
  ...
  ...props
}: LightboxImageProps): JSX_2.Element;
...
export function MultiAutocomplete({
  ...
  helperText,
  error,
}: MultiAutocompleteProps): JSX_2.Element;
...
// @public
export function readSecretsFromInitialValues(
  defaultEnv: Record<string, any>,
  apiEnv?: {
    name: string;
    value: string;
  }[],
...
export function SecretField({
  ...
  error,
  helperText,
}: SecretFieldProps): JSX_2.Element;
...
export function ServiceList({
  ...
  maxHeight,
  disabled,
}: ServiceListProps): JSX_2.Element;
...
export function TableSelector({
  ...
  tableList,
  disabled,
}: TableSelectorProps): JSX_2.Element;
